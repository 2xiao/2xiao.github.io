...
| 1 |        | 3 |  | 4 |
+---+        +---+  +---+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个例子中，包 2 丢失了，且不会被重传。</p><h3 id="_2-应用场景" tabindex="-1"><a class="header-anchor" href="#_2-应用场景" aria-hidden="true">#</a> 2. 应用场景</h3><p>UDP 通常用于实时应用，其中速度至关重要，且可以接受一些数据丢失：</p><ul><li><strong>直播流媒体</strong>：对于实时视频或音频流，丢失一两帧是可以接受的，因为重点是保持实时传输。</li><li><strong>在线游戏</strong>：在快速节奏的多人游戏中，数据到达的速度比顺序更重要。</li></ul><h3 id="_3-低开销" tabindex="-1"><a class="header-anchor" href="#_3-低开销" aria-hidden="true">#</a> 3. 低开销</h3><p>由于没有连接建立和重传机制，UDP 的开销远低于 TCP。因此，它的速度更快，但代价是可能会丢失数据。</p><h2 id="tcp-和-udp-的主要区别" tabindex="-1"><a class="header-anchor" href="#tcp-和-udp-的主要区别" aria-hidden="true">#</a> TCP 和 UDP 的主要区别</h2><p>以下是 TCP 和 UDP 的简明对比：</p><table><thead><tr><th>特性</th><th>TCP</th><th>UDP</th></tr></thead><tbody><tr><td>连接类型</td><td>面向连接</td><td>无连接</td></tr><tr><td>可靠性</td><td>保证（错误检查、重传）</td><td>不保证</td></tr><tr><td>顺序</td><td>保证</td><td>不保证</td></tr><tr><td>速度</td><td>由于开销较大，速度较慢</td><td>较快，开销较小</td></tr><tr><td>适用场景</td><td>网页浏览、电子邮件、文件传输</td><td>直播流媒体、在线游戏、DNS</td></tr></tbody></table><h2 id="结论" tabindex="-1"><a class="header-anchor" href="#结论" aria-hidden="true">#</a> 结论</h2><p>TCP 和 UDP 都在数据通信中扮演着重要角色，各自适用于不同的应用场景。TCP 是需要可靠、有序数据传输的应用的首选，而 UDP 则更适合那些对实时性要求更高、且可以接受偶尔数据丢失的应用。了解这些协议的优缺点，可以帮助你在开发网络应用时做出明智的选择。</p>`,37),s=[t];function r(l,c){return d(),i("div",null,s)}const u=e(n,[["render",r],["__file","4_tcp_and_udp.html.vue"]]);export{u as default};
